    ...
    public partial class PerfilesDeUsuario : Form
    {
        ...
        public Database AbrirBaseDeDatos()
        {
            try
            {
                ...
                //var connectionString = @"Data Source=(localdb)\MSSQLLocalDB; AttachDbFilename=|DataDirectory|\PLANILLAS.mdf;Connect Timeout=15;MultipleActiveResultSets=True; User Instance=False; User ID=Admin; pwd=Admin";
